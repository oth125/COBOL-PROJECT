      ...
      * Note that the - (minus sign) in FLD9-OUT consumes a blank
       DISPLAY-RESULTS.
           ...
           DISPLAY "FLD2-OUT " FLD2 "=>"  FLD2-OUT.
           DISPLAY "FLD3-OUT " FLD3 "=>" FLD3-OUT.
           DISPLAY "FLD4-OUT " FLD4 "=>" FLD4-OUT.
           DISPLAY "FLD5-OUT " FLD5 "=>" FLD5-OUT.
           DISPLAY "FLD6A-OUT " FLD6 "=>" FLD6A-OUT.
           DISPLAY "FLD6B-OUT "FLD6 "=>" FLD6B-OUT.
           DISPLAY "FLD7-OUT " FLD7 "=>" FLD7-OUT.
           DISPLAY "FLD8-OUT " FLD8 "=>" FLD8-OUT "END OF FLD8-OUT".
           DISPLAY "END".
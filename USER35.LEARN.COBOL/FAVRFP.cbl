       ...
       PROGRAM-ID. FAVRFP.
      ***** This MODULE Workshop 8.1 - Create new COBOL program
      *****  THAT USES A FILE READ - IF STATMENTS / EVALUATE
       ENVIRONMENT DIVISION.
       INPUT-OUTPUT SECTION.
       FILE-CONTROL.
           SELECT RFP-INFILE  ASSIGN TO RFPIN
                          FILE STATUS IS FAVIN-F-STATUS.
           SELECT RFP-RPTOUT    ASSIGN TO PROPOSAL.
       DATA DIVISION.
       FILE SECTION.
       FD  RFP-INFILE
           RECORDING MODE IS F
       ...
       01 FAVIN-REC.
          05 ARTIST-ACCT-NO.
             10 RECORD-TYPE-FLAG PIC X(01).
                88 COMMENTED-RECORD  VALUE 'C'.
             10 REST-OF-ARTIST-ACCT-NO  PIC X(07).
          05 MUSICAL-GENRE              PIC X(10).
              88  ROCK VALUE 'ROCK'.
              88  JAZZ VALUE 'JAZZ'.
          ...
          05  MUSICIAN-INSTRUMENT-TYPE PIC X(10).
      ...
      *       COMPUTED DATAITEMS
       ...
       PROCEDURE DIVISION.
           OPEN INPUT RFP-INFILE.
           OPEN OUTPUT RFP-RPTOUT.
